...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('departments', '0003_department_employee_department'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='department',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='departments.department', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='department',
            name='tn_priority',
